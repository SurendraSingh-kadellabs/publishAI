        ...
        <div class="col-12 col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 style="font-size:26px;">{{__('Edit Users')}}</h4>
            ...
            <!-- <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    ...
                    <select class="form-control" name="role" aria-label="Default select example">
                        ...
                        <option value="5" <?=($user->role=='5')?'selected':''?>>Reviewer</option>
            ...
            <div>
                <button id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">Update
                </button>
            </div>
        </form>
